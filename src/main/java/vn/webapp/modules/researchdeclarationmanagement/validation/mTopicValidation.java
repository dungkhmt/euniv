...
public class mTopicValidation {
	...
	public void setTopicStartDate(String topicStartDate) {
	...
	public void setTopicEndDate(String topicEndDate) {
		this.topicEndDate = topicEndDate;
	}

	public String getTopicMemberRole() {
		return topicMemberRole;
	}

	public void setTopicMemberRole(String topicMemberRole) {
		this.topicMemberRole = topicMemberRole;
	}

	public String getTopicSponsor() {
		return topicSponsor;
	}

	public void setTopicSponsor(String topicSponsor) {
