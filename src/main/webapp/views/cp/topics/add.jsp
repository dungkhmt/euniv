        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form:form action="${baseUrl}/cp/save-a-topic.html" method="POST" commandName="topicFormAdd" role="form" enctype="multipart/form-data">
	                    <div class="row">
	                        <div class="col-lg-6">
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <form:input path="topicName" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc" name="topicName" placeholder="Project Name"></form:input>
	    								<form:errors path="topicName" class="alert-danger"></form:errors>
	                                </div>
	                                <div class="form-group">
	                                    <label for="topicConHours">Giờ quy đổi*</label>
	                                    <form:input path="topicConHours" class="form-control" data-validation="custom required" data-validation-regexp="^[0-9]*[1-9][0-9]*$" data-validation-error-msg="Giá trị phải là số nguyên" name="topicConHours" placeholder="Publilcation Converted Hours"></form:input>
	                            	...
	                            	<div class="form-group">
	                                    ...
	                                    <form:input path="topicSponsor" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc" name="topicSponsor" placeholder="Sponsor"></form:input>
	                        ...
	                        <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input path="topicStartDate" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc" name="topicStartDate" readonly="true" placeholder="DD/MM/YYYY"></form:input>
