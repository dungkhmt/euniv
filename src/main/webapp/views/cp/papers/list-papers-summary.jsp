...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Tổng hợp danh sách bài báo</h1>
			<p>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">Tổng hợp danh sách bài báo</div>
				<!-- /.panel-heading -->
...
$(document).ready(function() {
    ...
    $('.back').click(function(){
    	window.location = baseUrl+"/cp/summary-papers.html";
    });
