		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form:form action="${baseUrl}/cp/booksSummary" method="POST" id="formSubmit" commandName="bookSummaryForm" role="form">
					<div class="row">
                       <div class="col-lg-6">
                       	<div class="panel panel-default">
	                        <div class="panel-heading">
	                            <b>Chọn thông tin sách giáo trình</b>
	                        </div>
		                        <!-- /.panel-heading -->
		                        <div class="panel-body">
		                        	<div>
		                                <label for="bookReportingAcademicYear">Năm kê khai</label>
		                                <div class="form-group">
		                                   	 <form:select class="form-control" path="bookReportingAcademicYear">
					                        	<c:forEach items="${bookReportingAcademicYearList}" var="bookReportingAcademicYear">
				                                 	<option value="${bookReportingAcademicYear.ACAYEAR_Code}">${bookReportingAcademicYear.ACAYEAR_Code}</option>
				                               	</c:forEach>
					                        </form:select>
		                                </div>
	                                </div>
	                        ...
	                        <div class="panel-heading">
		                        ...
		                        <div class="panel-body">
		                        	<div>
		                        		...
		                        		<div class="form-group">
		                                   	<form:select class="form-control" path="bookFaculty" onchange="showDepartment(this);">
