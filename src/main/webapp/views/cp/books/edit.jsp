...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Chỉnh sửa thông tin sách giáo trình</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <form:form action="${baseUrl}/cp/edit-a-book.html" method="POST" commandName="bookFormEdit" role="form" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Chỉnh sửa thông tin sách giáo trình
                </div>
	                    ...
	                    <div class="row">
	                        <div class="col-lg-6">
	                                <div class="form-group">
	                                    ...
	                                    <form:input path="bookName" value="${bookName}" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc"  name="bookName" placeholder="Book Name"></form:input>
	    								<form:errors path="bookName" class="alert-danger"></form:errors>
	                                </div>
	                                <div class="form-group">
	                                    <label for="bookPublisher">Nhà xuất bản*</label>
	                                    <form:input path="bookPublisher" value="${bookPublisher}" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc"  name="bookPublisher" placeholder="Book Publisher Name"></form:input>
	                                ...
	                                <div class="form-group">
		                                ...
		                                <form:select path="bookMonth" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc"  name="bookMonth" >
		                                	<% for(int i = 1; i<=12; i++) { %>
		                                   	...
		                                   	<% } %>
		                                   	<option selected="selected" value ="${bookMonth}" >Tháng ${bookMonth}</option>
		                                </form:select>
            ...
            <div class="panel panel-default">
	                        ...
	                        <div class="panel-body">
	                            <div class="table-responsive">
	                                <table class="table table-striped table-bordered table-hover" id="projectMemberList">
	                                    ...
	                                    <tbody>
	                                        <c:choose>
													<c:when test="${not empty listBookStaffs}">
				                                    	<c:forEach items="${listBookStaffs}" var="bookStaff">
				                                    		<tr>
					                                            <td>
					                                            	<c:out value="${bookStaff.BOKSTF_StaffCode}"/>
					                                            	<input name='projectMembers' type='hidden' value="${bookStaff.BOKSTF_StaffCode}" />
					                                            </td>
                ...
                <!-- /.panel-body -->
               	 ...
               	 <form:hidden path="bookId" name="bookId" value="${bookId}"/>
                <button type="submit" class="btn btn-primary" id="editABook">Lưu</button>
