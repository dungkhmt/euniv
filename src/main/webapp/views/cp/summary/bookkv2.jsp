...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Kết xuất tổng hợp mẫu KV 02 cho sách giáo trình</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form:form action="${baseUrl}/cp/summaryExcel02KVBook" method="POST" commandName="summaryFormExcel02KVBook" role="form">
	                    <div class="row">
	                        <div class="col-lg-6">
