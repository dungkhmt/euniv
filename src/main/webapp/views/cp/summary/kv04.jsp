...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Kết xuất tổng hợp mẫu 04 KV</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form:form action="${baseUrl}/cp/summaryExcelKV04" method="POST" commandName="summaryExcelFormKV04" role="form">
	                    <div class="row">
	                        <div class="col-lg-6">
